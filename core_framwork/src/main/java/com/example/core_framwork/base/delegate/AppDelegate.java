...
import com.example.core_framwork.base.App;
import com.example.core_framwork.base.BaseApplication;
import com.example.core_framwork.di.component.AppComponent;
import com.example.core_framwork.di.component.DaggerAppComponent;
import com.example.core_framwork.di.module.GlobalConfigModule;
import com.example.core_framwork.integration.ConfigModule;
import com.example.core_framwork.integration.ManifestParser;
import com.example.core_framwork.integration.cache.IntelligentCache;
...
public class AppDelegate implements App, AppLifecycles {
     ...
     *
     * @return AppComponent
     * @see com.example.core_framwork.utils.CoreUtils#obtainAppComponentFromContext(Context) 可直接获取 {@link AppComponent}
     */
    @NonNull
    @Override
