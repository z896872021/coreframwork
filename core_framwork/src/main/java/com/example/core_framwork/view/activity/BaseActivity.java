...
import static com.example.core_framwork.utils.ThirdViewUtil.convertAutoView;
...
public abstract class BaseActivity<P extends IPresenter> extends AppCompatActivity implements IActivity, ActivityLifecycleable {
    ...
    public synchronized Cache<String, Object> provideCache() {
        if (mCache == null) {
            mCache = CoreUtils.obtainAppComponentFromContext(this).cacheFactory().build(CacheType.ACTIVITY_CACHE);
        }
        return mCache;
    }
